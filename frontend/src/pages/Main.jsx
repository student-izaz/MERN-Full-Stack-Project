    ...
    <>
      <div className="main-content">
        <div className="main-text">
          <h1>
            Welcome to <span>Techpile Technology</span>
          </h1>
          <div className="animation-text">
            <span className="text first-text" style={{ color: "#656565" }}>
              Learn
            </span>
            <span className="text sec-text"></span>
          </div>
          <p>
            Our training session program to enhance knowledge to the next level
            and to make you afficience to work with a reputated
            organization.Techpile teach basics and those coding techniques to
            people in short time which took me ages to learn.
          </p>
          <div className="free-course-btn">
            <Link to="/course">Popular Courses</Link>
          </div>
        </div>
      ...
      <div className="training">
        <div className="training_head">
          <h1>
            <span>Training</span> at Techpile
          </h1>
      ...
      <div id="services">
        <div id="service_head">
          <h1>
            <span>Techpile</span> In{" "}
            <span style={{ color: "rgb(240, 174, 50)" }}>Web Designing</span> &
            Development
          </h1>
          <p>
            Our Services are designed to make your business to the next
            level,reducing the gap between you and the height of success you
            wish to acheive.
          </p>
        </div>
        <div className="service-content">
          <div className="service_box">
            ...
            <p>
              ...
              Cupiditate consectetur suscipit, similique ducimus error, pariatur
              exercitationem! Ducimus distinctio repellendus iusto dolore
              sapiente non dolor!
            </p>
          </div>
          <div className="service_box">
      ...
      <div id="training_program">
        <div id="training_program_head">
          <h1>
            Amazing <span style={{ color: "rgb(240, 174, 50)" }}>Training</span>{" "}
            Programs
          </h1>
          <p>
            We are more appreciate in the field of Training as well. Techpile
            offers you the best
            <br />
            development training via experienced consultants.
          </p>
        </div>
      ...
      <div className="learning_app">
        <div className="cover">
          <div className="text">
            ...
            <br />
            <br />
            <p>Download application and grow your knowledge.</p>
            <br />
            <br />
      ...
      <div id="testimonial">
        ...
        <div id="reviews">
          {feedbacks.map((item) => {
            return <div className="review_box" key={item._id}>
          ...
          <div className="testimonial-arrow" id="arrowl">
            <i className="fa-solid fa-angle-left"></i>
          </div>
          <div className="testimonial-arrow" id="arrowr">
